    ...
    <div className="relative h-[50vh] md:h-[65vh] w-full overflow-hidden">
        {backdropUrl ? (
             <>
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-vista-light dark:from-black via-transparent to-black/30"></div>
             </>
        ) : (
            <div className="w-full h-full bg-neutral-800 flex items-center justify-center">
                <span className="text-neutral-600">Görsel Yok</span>
            </div>
        )}
        ...
        <div className="absolute top-0 left-0 right-0 p-4 md:p-8 flex justify-between items-center z-50">
            ...
            <button 
                ...
                className={`px-5 py-2.5 rounded-full backdrop-blur-md font-bold text-sm transition-all flex items-center gap-2 ${
                    isInCollection 
